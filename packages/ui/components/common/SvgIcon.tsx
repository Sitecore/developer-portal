...
export type IconNames = 'arrow-left' | 'arrow-right' | 'checkbox-empty' | 'checkbox-filled' | 'chevron-down' | 'chevron-left' | 'chevron-right' | 'heading' | 'quick-links' | 'github' | 'close' | 'feed' | 'edit' | 'info' | 'error' | 'alert';
