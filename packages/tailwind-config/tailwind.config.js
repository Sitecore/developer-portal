import { backgroundSize as _backgroundSize, fontFamily as _fontFamily } from 'tailwindcss/defaultTheme';
...
export const theme = {
  ...
  fontFamily: {
    sans: ['var(--font-avenirnext-r)', ..._fontFamily.sans],
    ltpro: ['var(--font-avenirnext-ltpro)', ..._fontFamily.serif],
  },
  fontSize: {
    // 12px
    '2xs': '0.75rem',
