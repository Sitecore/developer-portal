...
export async function getStaticProps(context: any) {
  const starterKits = await getPartialsAsArray(['learn/starter-kits/xm-cloud', 'learn/starter-kits/ordercloud', 'learn/starter-kits/sitecore-starter-kits']);
  ...
  return {
    props: {
      pageInfo: await getPageInfo('learn', context.preview ? context.preview : null),
      partialGroups,
    },
