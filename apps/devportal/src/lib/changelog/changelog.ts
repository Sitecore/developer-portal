...
export function getChangelogCredentials(): ChangelogCredentials {
  return {
    production: {
      endpoint: process.env.NEXT_PUBLIC_SITECORE_CHONE_ENDPOINT_DELIVERY as string,
      token: process.env.NEXT_PUBLIC_SITECORE_CHONE_AUTH_TOKEN_DELIVERY as string,
    },
    preview: {
      endpoint: process.env.NEXT_PUBLIC_SITECORE_CHONE_ENDPOINT_PREVIEW as string,
      token: process.env.NEXT_PUBLIC_SITECORE_CHONE_AUTH_TOKEN_PREVIEW as string,
    },
  };
}
