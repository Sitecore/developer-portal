...
const SitecoreCommunityQuestions = ({ data, sortKeys, forumKeys, ...rest }: SitecoreCommunityQuestionsProps): JSX.Element => {
  ...
  return (
    <Card shadow={'none'} {...rest} background={'transparent'} variant={'unstyled'} width={'100%'}>
      <CardHeader justifyContent={'space-between'} display={'flex'}>
        ...
        <ButtonLink href={'https://community.sitecore.com/community?id=community_forum&sys_id=671511531b357810486a4083b24bcb62'} text={'See all'} />
      </CardHeader>
