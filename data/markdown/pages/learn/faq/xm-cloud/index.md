---
product: ['xm-cloud']
title: 'SitecoreAI FAQ'
description: 'Learn more about SitecoreAI and all of the features.'
hasInPageNav: true
cdpTags: ['xm-cloud']
---
...
SitecoreAI is a cloud-native, hybrid headless CMS, for developers and marketers to efficiently launch engaging omnichannel experiences. SitecoreAI bundles:
...
- Experience Edge, since SitecoreAI is a SaaS solution
...
## If SitecoreAI is a hybrid headless CMS, what does that mean?
...
SitecoreAI re-imagines the CMS and introduces a no-compromise approach that delivers developer agility through the best attributes of the hybrid headless CMS, while empowering marketers through a visual page composition experience. With SitecoreAI, customers deliver to their markets:
...
## What’s the difference between Experience Manager, Experience Platform, and SitecoreAI?
...
- SitecoreAI is a cloud-native SaaS. That means that SitecoreAI is developed, designed, and deployed as a cloud-native app built with a composable architecture, centrally hosted, and licensed using a subscription model. SitecoreAI is a hybrid headless, Jamstack-ready, CMS and introduces next-gen visual authoring through its Pages and Components tools. Pages includes embedded personalization and analytics.
