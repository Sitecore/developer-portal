...
description: 'How do you integrate 3rd Party applications into SitecoreAI''s Head Application?'
area: ['accelerate']
hasSubPageNav: true
hasInPageNav: true
...
Within this chapter we will not only cover how to properly offer 3rd Party integrations, but also explicitly highlight ways, how we should not do it anymore in a modern composable SitecoreAI architecture.
...
Do not import or sync those data as Items into SitecoreAI as it would cause massive unwanted and unneeded maintenance overhead afterwards.
...
The table below shows a step by step guide on how to create a custom react editing component, which allows the editors to visually see the 3rd Party data and choose 1 or more of them. The result will be automatically saved back to SitecoreAI Datasource item.
