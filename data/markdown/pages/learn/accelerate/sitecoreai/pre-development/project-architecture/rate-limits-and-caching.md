...
- [Dictionary service](https://github.com/sitecorelabs/xmcloud-foundation-head/blob/main/headapps/nextjs-starter/src/lib/dictionary-service-factory.ts)
...
- [Personalize middleware](https://github.com/sitecorelabs/xmcloud-foundation-head/blob/main/headapps/nextjs-starter/src/lib/middleware/plugins/personalize.ts)
  - Increase the default `cacheTimeout` (10s default)
  - If your client is not using Personalize, disable or remove the middleware
- [Redirects middleware](https://github.com/sitecorelabs/xmcloud-foundation-head/blob/main/headapps/nextjs-starter/src/lib/middleware/plugins/redirects.ts)
  - Increase the default `cacheTimeout` (10s default)
