...
### 6.2	Identify returning visitors and merge current session data with historical session data.
...
### 6.3	Customising, Retrieving & Updating user information stored in Sitecore CDP.
...
### 6.4	Track goals & conversions on the web channel.
...
### 6.5	Ability to personalize web channel.
...
### 6.6	Ability to optimize web channel through Experiments.
