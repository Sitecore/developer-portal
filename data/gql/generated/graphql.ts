...
export type Changelog_Image_Relations = {
	...
	AND: InputMaybe<
		Array<
			InputMaybe<Changelog_Image_XmcMedia__Upload__Changetype__Status__SitecoreCloud__SitecoreProduct__Changelog_Relations>
		>
	>;
	/** Combines multiple filter conditions. */
	OR: InputMaybe<
...
export type Changelog_SitecoreProduct_Relations = {
	/** Combines multiple filter conditions. */
	AND: InputMaybe<
		Array<InputMaybe<Changelog_SitecoreProduct_SitecoreProduct_Relations>>
	>;
	/** Combines multiple filter conditions. */
	OR: InputMaybe<
		Array<InputMaybe<Changelog_SitecoreProduct_SitecoreProduct_Relations>>
...
export type SitecoreProduct_ProductIcon_Relations = {
	...
	AND: InputMaybe<
		Array<
			InputMaybe<SitecoreProduct_ProductIcon_XmcMedia__Upload__Changetype__Status__SitecoreCloud__SitecoreProduct__Changelog_Relations>
		>
	>;
	/** Combines multiple filter conditions. */
	OR: InputMaybe<
...
export type SitecoreProduct_SitecoreCloud_Relations = {
	...
	AND: InputMaybe<
		Array<
			InputMaybe<SitecoreProduct_SitecoreCloud_XmcMedia__Upload__Changetype__Status__SitecoreCloud__SitecoreProduct__Changelog_Relations>
		>
	>;
	/** Combines multiple filter conditions. */
	OR: InputMaybe<
...
export type ChangelogEntryFragment = {
	...
	image: {
		...
		results: Array<
			| {
					media_publicLink: string | null;
					media_type: Array<{ name: string } | null> | null;
					system: { id: string; name: string };
			  }
			| {}
			| null
	...
	changeType: {
		results: Array<
			| { changeType: string | null; system: { id: string; name: string } }
			| {}
			| null
		> | null;
	} | null;
	status: {
		results: Array<
			| {
					...
					system: { id: string; name: string; label: string | null };
			  }
			| {}
			| null
		> | null;
...
export type GetNumberOfEntriesByProductQuery = {
	changelog: {
		hasMore: boolean | null;
		results: Array<{ system: { id: string } } | null> | null;
	} | null;
};
...
export type SearchByProductsAndChangeTypesAndBreakingChangeQueryVariables =
	Exact<{
		date: InputMaybe<Scalars["CustomDateTime"]["input"]>;
		productIds: InputMaybe<
			Array<Scalars["String"]["input"]> | Scalars["String"]["input"]
...
>;
export const SearchByChangeTypesAndBreakingChangeDocument =
...
>;
export const SearchByProductsAndChangeTypesAndBreakingChangeDocument =
	new TypedDocumentString(`
