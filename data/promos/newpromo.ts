...
const data: PromoCardProps = {
  ...
  description:
    'We want to hear from you! Take the Developer Experience Survey if you’ve worked professionally with the Sitecore platform or contributed to a project in the past 12 months. Your answers will help shape our future.!',
  img: {
