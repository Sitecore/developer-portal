...
const platformData = {
  title: "Capabilities",
  subtitle:
    "Discover the power of SitecoreAI capabilities for every aspect of digital experience delivery.",
  data: [
    {
      title: "Content management",
      description:
        "Manage, design, and deliver experiences that scale with your ambition.",
    ...
    },
    {
      ...
      description:
        "Organize, find, and deliver assets fast with a platform that fuels creativity and control.",
    ...
    },
    {
      ...
      description:
        "Unify content and AI in one hub that keeps work moving and results growing.",
    ...
    },
    {
      ...
      description:
        "Unlock your customer data to inform every interaction with real-time insights.",
    ...
    },
    {
      ...
      description:
        "Personalize every experience with intelligence that understands your customers.",
