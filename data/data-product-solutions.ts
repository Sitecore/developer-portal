import type { CategoryTileProps } from "@/src/components/lists";
...
export const productSolutions: CategoryTileProps[] = [
	...
	},
	{
		...
		description:
			"Scale management, workflow and delivery of content, media and static assets",
	...
	},
	{
		...
		description:
			"Deliver personalized content and test which content is working",
	...
	},
	{
		title: "Commerce",
		description:
			"Build out order management, merchandising, marketplaces, and storefronts",
		href: "/commerce/",
	},
	{
		title: "DevOps",
