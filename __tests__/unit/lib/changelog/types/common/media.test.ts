import { parseMediaItem, parseMediaItems } from '@lib/changelog/types/common/media';
...
describe('parseMediaItem', () => {
  ...
  test('should throw error for null item', () => {
    expect(() => parseMediaItem(null)).toThrow('Invalid Media: rawItem is null or undefined');
  });

  test('should throw error for undefined item', () => {
    expect(() => parseMediaItem(undefined)).toThrow('Invalid Media: rawItem is null or undefined');
  });
