import { DefaultStatus, ParseStatus, parseStatusItem } from '@lib/changelog/types/status';
...
describe('parseStatusItem', () => {
  ...
  test('should throw error for null item', () => {
    expect(() => parseStatusItem(null)).toThrow('Invalid Status: rawItem is null or undefined');
  });

  test('should throw error for undefined item', () => {
    expect(() => parseStatusItem(undefined)).toThrow('Invalid Status: rawItem is null or undefined');
  });
