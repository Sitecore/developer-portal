...
describe('GraphQL Query Integration Tests', () => {
  ...
  function validateChangelogEntry(entry: any) {
    ...
    if (entry.readMoreLink !== null) expect(typeof entry.readMoreLink).toBe('string');
    if (entry.breakingChange !== null) expect(typeof entry.breakingChange).toBe('boolean');
    ...
    if (entry.scheduled !== null) expect(typeof entry.scheduled).toBe('boolean');
    ...
    if (entry.sitecoreProduct !== null && entry.sitecoreProduct.results !== null) {
  ...
  function validateProduct(product: any) {
    ...
    if (product.productName !== null) expect(typeof product.productName).toBe('string');
    if (product.productDescription !== null) expect(typeof product.productDescription).toBe('string');
    if (product.darkIcon !== null) expect(typeof product.darkIcon).toBe('string');
    if (product.lightIcon !== null) expect(typeof product.lightIcon).toBe('string');
  }
  ...
  function validateChangeType(changeType: any) {
    ...
    if (changeType.changeType !== null) expect(typeof changeType.changeType).toBe('string');
  }
  ...
  function validateStatus(status: any) {
    ...
    if (status.description !== null) expect(typeof status.description).toBe('string');
    if (status.identifier !== null) expect(typeof status.identifier).toBe('string');
    if (status.system.label !== null) expect(typeof status.system.label).toBe('string');
  }

  describe('GetAllProducts', () => {
    test('should fetch all products with correct structure', async () => {
      const result = await fetchGraphQL<GetAllProductsQuery, GetAllProductsQueryVariables>(GetAllProductsDocument, credentials, preview);
      ...
      if (products) {
        ...
        if (products.cursor !== null) expect(typeof products.cursor).toBe('string');
  ...
  describe('GetAllChangetypes', () => {
    test('should fetch all change types with correct structure', async () => {
      const result = await fetchGraphQL<GetAllChangetypesQuery, GetAllChangetypesQueryVariables>(GetAllChangetypesDocument, credentials, preview);
      ...
      if (changeTypes) {
        ...
        if (changeTypes.cursor !== null) expect(typeof changeTypes.cursor).toBe('string');
  ...
  describe('GetAllStatus', () => {
    test('should fetch all statuses with correct structure', async () => {
      const result = await fetchGraphQL<GetAllStatusQuery, GetAllStatusQueryVariables>(GetAllStatusDocument, credentials, preview);
      ...
      if (statuses) {
        ...
        if (statuses.cursor !== null) expect(typeof statuses.cursor).toBe('string');
  ...
  describe('SearchByDate', () => {
    test('should fetch changelog entries by date range', async () => {
      ...
      const result = await fetchGraphQL<SearchByDateQuery, SearchByDateQueryVariables>(SearchByDateDocument, credentials, preview, {
        startDate,
        endDate,
        first: 5,
      });
      ...
      if (changelog) {
        ...
        if (changelog.cursor !== null) expect(typeof changelog.cursor).toBe('string');
    ...
    test('should support pagination with cursor', async () => {
      ...
      const firstResult = await fetchGraphQL<SearchByDateQuery, SearchByDateQueryVariables>(SearchByDateDocument, credentials, preview, {
        startDate,
        endDate,
        first: 2,
      });
      ...
      if (firstChangelog && firstChangelog.hasMore && firstChangelog.cursor) {
        const secondResult = await fetchGraphQL<SearchByDateQuery, SearchByDateQueryVariables>(SearchByDateDocument, credentials, preview, {
          startDate,
          endDate,
          first: 2,
  ...
  describe('SearchByProduct', () => {
    test('should fetch changelog entries by product', async () => {
      ...
      const productsResult = await fetchGraphQL<GetAllProductsQuery, GetAllProductsQueryVariables>(GetAllProductsDocument, credentials, preview);
      ...
      const result = await fetchGraphQL<SearchByProductQuery, SearchByProductQueryVariables>(SearchByProductDocument, credentials, preview, {
        date,
        productId: [productId],
        first: 5,
      });
    ...
    test('should filter by change type IDs', async () => {
      const productsResult = await fetchGraphQL<GetAllProductsQuery, GetAllProductsQueryVariables>(GetAllProductsDocument, credentials, preview);
      const changeTypesResult = await fetchGraphQL<GetAllChangetypesQuery, GetAllChangetypesQueryVariables>(GetAllChangetypesDocument, credentials, preview);

      const products = productsResult.data.manySitecoreProduct?.results;
      const changeTypes = changeTypesResult.data.manyChangetype?.results;

      if (!products || products.length === 0 || !changeTypes || changeTypes.length === 0) {
  ...
  describe('SearchByTitle', () => {
    test('should fetch changelog entries by title', async () => {
      ...
      const result = await fetchGraphQL<SearchByTitleQuery, SearchByTitleQueryVariables>(SearchByTitleDocument, credentials, preview, {
        date,
        productId: [productId],
        entryTitle: ['test'],
      });
  ...
  describe('SearchByTitleAndDate', () => {
    test('should fetch changelog entries by title and date range', async () => {
      ...
      const result = await fetchGraphQL<SearchByTitleAndDateQuery, SearchByTitleAndDateQueryVariables>(SearchByTitleAndDateDocument, credentials, preview, {
        startDate,
        endDate,
        productId,
        entryTitle: ['test'],
  ...
  describe('SearchByProductsAndChangeTypes', () => {
    test('should fetch changelog entries by products and change types', async () => {
      ...
      const changeTypeIds = [changeTypes[0]?.system.id].filter(Boolean) as string[];
      ...
      const result = await fetchGraphQL<SearchByProductsAndChangeTypesQuery, SearchByProductsAndChangeTypesQueryVariables>(SearchByProductsAndChangeTypesDocument, credentials, preview, {
        date,
        productIds,
        changeTypeIds,
        entryTitle: [],
  ...
  describe('SearchByProductsAndChangeTypesAndBreakingChange', () => {
    test('should fetch changelog entries with breaking change filter', async () => {
      ...
      const breakingResult = await fetchGraphQL<SearchByProductsAndChangeTypesAndBreakingChangeQuery, SearchByProductsAndChangeTypesAndBreakingChangeQueryVariables>(SearchByProductsAndChangeTypesAndBreakingChangeDocument, credentials, preview, {
        date,
        productIds,
        changeTypeIds: [],
        breaking: true,
      ...
      if (breakingChangelog && breakingChangelog.results) {
      ...
      const nonBreakingResult = await fetchGraphQL<SearchByProductsAndChangeTypesAndBreakingChangeQuery, SearchByProductsAndChangeTypesAndBreakingChangeQueryVariables>(SearchByProductsAndChangeTypesAndBreakingChangeDocument, credentials, preview, {
        date,
        productIds,
        changeTypeIds: [],
        breaking: false,
  ...
  describe('GetNumberOfEntriesByProduct', () => {
    test('should fetch number of entries by product ID', async () => {
      ...
      const result = await fetchGraphQL<GetNumberOfEntriesByProductQuery, GetNumberOfEntriesByProductQueryVariables>(GetNumberOfEntriesByProductDocument, credentials, preview, {
        productId: [productId],
      });
    ...
    test('should handle multiple product IDs', async () => {
      ...
      const productIds = [products[0]?.system.id, products[1]?.system.id].filter(Boolean) as string[];
