...
export const mockedChangelogEntries: ChangelogEntry[] = [
	{
		...
		title:
			"In Forms, make a file upload item visible based on conditional logic",
		description:
	...
	},
	{
		...
		readMoreLink: "",
		title:
			"Action required: MVC artifacts temporarily restored in base image 1.6.46",
		description:
	...
	},
	{
		...
		description:
			"<ul><li><p>Dynamic filters in search results now work as intended. <em>(MONE-46539)</em></p></li></ul>",
		fullArticle: null,
		breakingChange: false,
		sitecoreProduct: [
			{
	...
	},
	{
		...
		readMoreLink:
			"https://doc.sitecore.com/xmc/en/users/xm-cloud/specifying-variables-for-conditions.html",
		...
		image: [
			{
				...
				fileUrl:
					"https://mms-delivery.sitecorecloud.io/api/media/v2/delivery/da693ca9-8504-4b34-319a-08db21b77927/3cf1860ea0d04caf8b1df611c82f46a2",
				description: "",
				fileWidth: 827,
				fileHeight: 231,
