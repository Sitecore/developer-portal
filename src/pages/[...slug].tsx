...
import {
  getChildNavgationInfo,
  getChildPageInfo,
  getPageInfo,
} from "@src/lib/page-info";
...
const ChildOverviewPage = dynamic(
  () => import("@src/layouts/ChildOverviewPage"),
  {
    loading: () => <div className="min-h-screen" />,
  },
);
...
const DefaultContentPage = dynamic(
  () => import("@src/layouts/DefaultContentPage"),
  {
    loading: () => <div className="min-h-screen" />,
  },
);
...
export async function getStaticProps(context: any) {
  ...
  const childPageInfo =
    pageInfo.pageType === "childoverview" || pageInfo.pageType === "newsletter"
      ? await getChildPageInfo(context.params.slug.join("/"))
      : null;
  let sidebarNavConfig = null;

  if (pageInfo.hasSubPageNav) {
    sidebarNavConfig = await getChildNavgationInfo(
