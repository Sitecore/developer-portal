        ...
        <VerticalGroup className="min-h-[calc(100vh-430px)]">
          <CenteredContent>
            <Alert variant="default" className="my-4">
              ...
              <AlertDescription>
                <p>
                  We are refreshing how we present our product roadmap on this
                  site to ensure consistency across all public materials. We
                  will continue to share forward-looking information through an
                  updated roadmap on this site at a later stage.
                </p>
              </AlertDescription>
            </Alert>
          </CenteredContent>
