...
const Search: NextPage<SearchPageProps> = ({ pageInfo, currentProduct, products: _products }) => {
          ...
          <CenteredContent>
            ...
            <div className="flex flex-col gap-4 w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[5px] w-full">
                ...
                <RoadmapPhase roadmap={data} title="Now (this quarter)" color="var(--color-green-100)" phase={Phase.NOW} isLoading={isLoading} />
                <RoadmapPhase roadmap={data} title="Next (next two quarters)" color="var(--color-orange-100)" phase={Phase.NEXT} isLoading={isLoading} />
