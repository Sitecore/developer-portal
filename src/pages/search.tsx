  ...
  return (
    <TrackPageView pageInfo={pageInfo}>
      <Layout title={pageInfo.title} description={pageInfo.description} openGraphImage={pageInfo.openGraphImage}>
        ...
        <VerticalGroup className="bg-background">
          <CenteredContent>
            {IsSearchEnabled() ? (
              ...
              <Alert variant="default" className="border-yellow-500 bg-yellow-50 dark:bg-yellow-900/20">
                ...
                <AlertDescription>
                  <div className="flex flex-col gap-2 mt-4">
                    <p>
                      To enable search please update the following environment variables in the <code className="px-1 py-0.5 bg-muted rounded text-sm">.env</code> file:
                    </p>
