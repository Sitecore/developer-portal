...
const JavaScript = ({ width, height }: LogoComponent) => (
  <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={width} height={height}>
    <rect width="47.93" height="47.93" x="-0.04" y="0.11" fill="#1976d2" transform="matrix(1, 0, 0, 1, 1.7763568394002505e-15, 8.881784197001252e-16)" />
    <polygon fill="#fff" points="28.572 21.412 10.913 21.412 10.913 25.758 17.247 25.758 17.247 45.378 22.265 45.378 22.265 25.758 28.572 25.758" transform="matrix(1, 0, 0, 1, 1.7763568394002505e-15, 8.881784197001252e-16)" />
    <path
      fill="#fff"
