...
function CarouselPrevious({ className, variant = 'outline', colorScheme = 'neutral', size = 'icon', ...props }: React.ComponentProps<typeof Button>) {
...
function CarouselNext({ className, variant = 'outline', colorScheme = 'neutral', size = 'icon', ...props }: React.ComponentProps<typeof Button>) {
