      ...
      <Card className="shadow-lg">
        <CardContent className="py-10 px-4">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        variant="outline"
                        onClick={() =>
                          signIn("okta", { callbackUrl: redirectUrl })
                        }
                    ...
                    <TooltipContent>
                      <p>
                        Sign in using your Sitecore ID to get access to the
                        downloads
                      </p>
                    </TooltipContent>
                  </Tooltip>
          ...
          {!isDownloadsRedirect && (
            <>
              <p className="text-sm mb-8">
                To access the roadmap, please sign in using your Sitecore Cloud
                Portal account
              </p>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        variant="outline"
                        onClick={() =>
                          signIn("sitecore", { callbackUrl: redirectUrl })
                        }
                        className="flex items-center gap-2"
                      >
                        <Icon
