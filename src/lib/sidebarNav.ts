 ...
 */
export const findCurrentLevel = (routes: Array<SidebarNavigationItem>, path: string): Array<SidebarNavigationItem> | null => {
 ...
 */
export const findRoute = (routes: Array<SidebarNavigationItem>, path: string): SidebarNavigationItem | null => {
  for (const route of routes) {
    if (route.path === path) {
      return route;
    }
 ...
 */
export const findAdjacentRoute = (routes: Array<SidebarNavigationItem>, currentPath: string, isNext: boolean): SidebarNavigationItem | null => {
 ...
 */
export const getParentRoute = (routes: Array<SidebarNavigationItem>, path: string): SidebarNavigationItem | null => {
  for (const route of routes) {
    if (route.children) {
