...
export type ChangelogPredicate = {
	...
	__sysCreatedAt_between: InputMaybe<
	...
	__sysCreatedBy_allOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	__sysCreatedBy_anyOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	...
	__sysCreatedBy_noneOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	__sysCreatedBy_startswith: InputMaybe<Scalars["String"]["input"]>;
	__sysUpdatedAt_between: InputMaybe<
		Array<InputMaybe<Scalars["DateTime"]["input"]>>
	>;
	...
	__sysUpdatedBy_allOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	__sysUpdatedBy_anyOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	...
	__sysUpdatedBy_noneOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	...
	__sysVersion_noneOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	...
	readMoreLink_noneOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	readMoreLink_startswith: InputMaybe<Scalars["String"]["input"]>;
	releaseDate_between: InputMaybe<
		Array<InputMaybe<Scalars["DateTime"]["input"]>>
	>;
...
export type Changelog__ChangeType_Parent_Types =
	| Changelog
	| Changetype
	| SitecoreCloud
	| SitecoreProduct
...
export type Changelog__SitecoreProduct_Parent_Types =
	| Changelog
	| Changetype
	| SitecoreCloud
	| SitecoreProduct
...
export type SitecoreProductPredicate = {
	...
	abbreviation_noneOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	...
	productIconDark_allOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	productIconDark_anyOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	...
	productIconDark_noneOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	productIconDark_startswith: InputMaybe<Scalars["String"]["input"]>;
	productIconLight_allOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	productIconLight_anyOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
	...
	productIconLight_noneOf: InputMaybe<
		Array<InputMaybe<Scalars["String"]["input"]>>
	>;
...
export type SitecoreProduct__SitecoreCloud_Parent_Types =
	| Changelog
	| Changetype
	| SitecoreCloud
	| SitecoreProduct
...
export type ChangeTypeFragment = {
	id: string | null;
	name: string | null;
...
export type ChangelogEntryFragment = {
	...
	changeType: {
		total: number | null;
		results: Array<
			| { id: string | null; name: string | null; changeType: string | null }
			| {}
			| null
		> | null;
	};
...
export type GetAllChangetypesQuery = {
	allChangetype: {
		total: number | null;
		results: Array<{
			id: string | null;
...
export type GetNumberOfEntriesByProductQuery = {
	changelog: { total: number | null } | null;
};
...
export type GetStatusByIdentifierQuery = {
	allStatus: {
		total: number | null;
		results: Array<{
			id: string | null;
...
fragment status on Status {
  ...
  identifier
	...
	GetLatestEntriesQuery,
	GetLatestEntriesQueryVariables
>;
...
export const GetStatusByIdentifierDocument = new TypedDocumentString(`
  ...
  identifier
	...
	GetStatusByIdentifierQuery,
	GetStatusByIdentifierQueryVariables
>;
